...
plot(gumb,t,col="blue",pch=20,xlab="",ylab="",main="PP Plot of Extreme Value - Gumbel")
...
plot(weib,t,col="blue",pch=20,xlim=c(0,1),ylim=c(0,1),xlab="",ylab="",main="PP Plot of Extreme Value - Weibull")
lines(dat,col="red",lwd=3)